        ...
        <div class="well">
            ...
            <form action="" method="post" name="reg">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="fullname" placeholder="example: Chris Dsouza" required>
                </div>
                <div class="form-group">
                    <label for="uname">User Name:</label>
                    <input type="text" class="form-control" name="uname" placeholder="exmple: chris20" required>
                </div>
                <div class="form-group">
                    <label for="uemail">Email:</label>
                    <input type="email" class="form-control" name="uemail" placeholder="example: dandelitourism@gmail.com" required>
                </div>
                <div class="form-group">
